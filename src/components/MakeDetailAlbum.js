...
const MakeDetailAlbum = () => {
    ...
    const [opt, setOpt] = useState('album');
    ...
    //삭제된 사진앨범페이지 화면
    const DeleteDetailAlbum = () => {
        return (
            <div className="delete-album-wrap">
                <div className="album-gap">
                    <div className="album-box">
...
export default MakeDetailAlbum;